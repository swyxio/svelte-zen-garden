<script>
  ...
  function renderCSS() {
    ...
    // let cssRules = ss.sheet.cssRules
    // console.log({ cssRules })
    // ss.sheet.insertRule(userCSS)
...
<div class="page-wrapper" on:mouseover={handleMouseenter} on:mousemove={recordMouseMove}>
  ...
  <section class="intro" id="zen-intro">
    <header role="banner">
      <h1>Svelte Zen Garden</h1>
      <h2>The Beauty of <abbr title="Cascading Style Sheets">CSS</abbr> Design, <em>Updated!</em></h2>
    </header>
  ...
  <div class="main supporting" id="zen-supporting" role="main">
    ...
    <div class="participation" id="zen-participation" role="article">
      ...
      <p>You may modify the style sheet in any way you wish, but not the <abbr
          title="HyperText Markup Language">HTML</abbr>. This may seem daunting at first if you’ve never worked this
        way before, but follow the listed links to learn more, and use the sample files as a guide.</p>
    ...
    <div class="requirements" id="zen-requirements" role="article">
      ...
      <p>Luckily, designing this way shows how well various browsers have implemented <abbr
        ...
        especially when you factor in mobile — pixel-perfect layouts may not be possible across every platform. That’s
      ...
      <p>We ask that you submit original artwork. Please respect copyright laws. Please keep objectionable material to
        a minimum, and try to incorporate unique and interesting visual themes to your work. We’re well past the point
